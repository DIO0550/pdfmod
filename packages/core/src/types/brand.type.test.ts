...
import type { ObjectNumber, GenerationNumber, ByteOffset } from "./brand.js";
...
test("エントリポイントから全Brand型がインポートできる", async () => {
  ...
  const _obj: import("../index.js").ObjectNumber = 1 as import("../index.js").ObjectNumber;
  const _gen: import("../index.js").GenerationNumber = 0 as import("../index.js").GenerationNumber;
  const _off: import("../index.js").ByteOffset = 512 as import("../index.js").ByteOffset;
  expect(_obj).toBe(1);
  expect(_gen).toBe(0);
